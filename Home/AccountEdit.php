...
<form name="edit" action="?target=<?php echo $target ?>&amp;section=AccountSave" method="post">

<?php

if (isset($_POST['CALID'])){
$UUID = validate(decryptfe($_POST['CALID']),'hd');
echo "<input type=\"hidden\" name=\"CALID\" value=\"" . encryptfe($UUID) . "\" size=\"20\" />";

$select = "UUID, PRNME, PSY, PEL";
$From = "tblpdu";
$Where = "UUID = '$UUID'";
$limit = '1';
...
$Email= validate(decrypt($row['PEL']),'hd');
...
<table width="100%" border="1">
    ...
    <td>
        ...
        ?>
        <input type="text" name="name" value="<?php echo $Name; ?>" size="25" /></td>
        <?php
    }else{
        echo $Name;
    }    ?>
    ...
    <td>
        <input type="email" name="email" value="<?php echo $Email; ?>" size="50" /></td>
    ...
    <td>
        <input type="text" name="username" value="" size="25" /></td>
    </tr>
    <tr>
    <th width="30%">Password</th>
    <td>
        <input type="password" name="password" value="" size="25" /></td>
    </tr>
    <tr>
    <th width="30%">Email Address</th>
    <td>
        <input type="email" name="email" value="" size="25" /></td>
    </tr>
